...
return [
    ...
    */
    ...
    'menu' => [
        ...
        [
            'text' => 'Petugas Inspeksi',
            'url' => 'inspektor/',
            'active' => ['inspektor*'],
            'icon' => 'fas fa-fw fa-user-secret',
            'can' => 'admin',
        ],
        ['header' => 'PROSES BERKAS'],
        [
            'text' => 'Buat Berkas Baru (Permohonan)',
            'url' => 'permohonan/create',
        ...
        [
            'text' => 'Proses Inspeksi',
            'url' => 'inspeksi/',
            'icon' => 'fas fa-fw fa-edit',
            'can' => ['inspeksi', 'admin']
        ],
        [
            'text' => 'Selesai Inspeksi',
            'url' => 'selesai_inspeksi/',
